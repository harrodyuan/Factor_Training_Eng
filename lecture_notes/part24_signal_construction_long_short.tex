...
assigning positions. The same feature can generate very different portfolios
depending on how it is standardized, combined, and rebalanced.

The example in this Part is intended only to illustrate the mechanics of this
mapping.
...
convenience sample, not a survivorship-free universe. The example is used only
to illustrate the mechanics of signal formation.

A simple signal may be formed from three ingredients:
...
These ingredients may be combined into a composite score and then mapped into
an equal-weight long-short portfolio.
